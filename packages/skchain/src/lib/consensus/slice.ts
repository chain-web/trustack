...
//       event: LifecycleStap.initingSlice,
//     });
//     const peerId = await this.db.cacheGet(skCacheKeys.accountId);
//     if (peerId) {
//       this.peerId = peerId;
//     } else {
//       throw new Error('did not found');
//     }
//     this.slice = (await this.db.cacheGet(this.sliceCacheName)) || 'o';

//     // 把缓存里的当前节点peers拿出来
//     const cid = this.db.get(this.slicePeersCacheName);
//     if (cid) {
//       try {
...
//       return;
//     }
//     const blockRoot = await this.blockService.blockRoot.rootCid;
