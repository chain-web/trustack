...
export const getStack = (): string[] => {
  ...
  if (err.stack) {
    err.stack.split('\n').forEach((line) => {
      ...
      // test case
      // at testClass.descriptor.value (/workspaces/trust-stack/packages/skchain/src/utils/performance.ts:36:23)

      // at async runTest (/workspaces/trust-stack/node_modules/.pnpm/jest-runner@29.4.1/node_modules/jest-runner/build/runTest.js:444:34)

      // at SKChain.decorateFunction [as transaction] (/workspaces/trust-stack/packages/skchain/src/utils/performance.ts:93:29)

      // at Object.<anonymous> (/workspaces/trust-stack/packages/skchain/tests/node.spec.ts:28:19)

      //     at async file:///workspaces/trust-stack/packages/sknode/dist/src/skchain.mjs:10:22
