...
export function wasmbindgentestcontext_args(
  a: number,
  b: number,
  c: number,
): void;
export function wasmbindgentestcontext_run(
  a: number,
  b: number,
  c: number,
): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcc6833f78ca783f0(
  a: number,
  b: number,
  c: number,
): void;
...
export function wasm_bindgen__convert__closures__invoke2_mut__h3dccb3e59e78a9da(
  a: number,
  b: number,
  c: number,
  d: number,
