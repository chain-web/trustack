...
const defaultMaxListeners = { max: 10 };
// By default EventEmitters will print a warning if more than 10 listeners are
// added to it. This is a useful default which helps finding memory leaks.
EventEmitter.defaultMaxListeners = defaultMaxListeners.max;

const setMaxListeners = function (
  n = defaultMaxListeners.max,
  ...eventTargets
) {
  if (eventTargets.length === 0) {
    defaultMaxListeners.max = n;
  } else {
